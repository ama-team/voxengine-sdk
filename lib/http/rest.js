...
function RestClient (settings, transport) {
  ...
  this.exists = function (resource, query, headers) {
    return request(Method.Head, resource, null, query, headers)
      .then(function (response) {
  ...
  this.get = function (resource, query, headers) {
    return request(Method.Get, resource, null, query, headers)
      .then(function (response) {
      ...
      return request(methods[method], resource, payload, query, headers)
        .then(function (response) {
          if (response.code === 404) {
            ...
            throw new Commons.NotFoundException(message, response.request, response)
          }
