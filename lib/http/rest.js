 ...
 * @property {VarArgLogger|undefined} logger Sink to send log messages into, default: just empty
 *   callback
 */
...
function RestClient(transport, settings) {
    ...
    function boolOption(_, def) {
        return typeof _ === 'undefined' ? def : !!_;
    }
    ...
    var baseUrl= settings.baseUrl || '',
        ...
        retryOnNetworkError = boolOption(settings.retryOnNetworkError, true),
        retryOnServerError = boolOption(settings.retryOnServerError, true),
        retryOnClientError = boolOption(settings.retryOnClientError, false),
        fixedHeaders = settings.headers || {},
...
/** @deprecated use {@link getDefaults} */
