...
function RestClient(settings, transport) {
    ...
    logger = opts.loggerFactory.create('ama-team.voxengine-sdk.http.rest');
...
function getDefaults() {
    return {
        ...
        headers: {},
        loggerFactory: new slf4j.Context()
    }
}
